...
// Body Tengah
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(initpos + position, 3, 0));
...
// Body Belakang
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(6 + position, 3, 0));
...
//Body Bawah Baling-Baling
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0 + position, 4, 0));
...
// Baling-Baling Belakang
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(7 + position, 3, 1));
